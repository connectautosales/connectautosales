...
const reviews = [
  {
    name: 'Mike R.',
    text: 'Great experience! The staff was very helpful and made the whole process easy. Highly recommend Connect Auto Sales!',
    stars: 5,
  },
  {
    name: 'Sarah M.',
    text: 'Honest dealership with quality vehicles. They provided all the information needed. Will buy from them again!',
    stars: 5,
  },
  {
    name: 'Jessica T.',
    text: 'Financing was quick and easy. The team was professional and answered all my questions.',
    stars: 5,
  },
]
          ...
          <div className={styles.reviewsGrid}>
            ...
            <div className={styles.reviewsLeft}>
              ...
              <div className={styles.ratingRow}>
                ...
                <span className={styles.ratingCount}>Based on 200+ reviews</span>
