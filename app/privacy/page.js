  ...
  },
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#e10001" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M8.5 8.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fill="#e10001"/>
        <path d="M15 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fill="#e10001"/>
        <path d="M9 15a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fill="#e10001"/>
        <path d="M14.5 15.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fill="#e10001"/>
      </svg>
    ),
  },
  {
          ...
          <div className={styles.contactBox}>
            <div className={styles.contactLeft}>
              <div className={styles.contactIconWrap}>
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#e10001" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                ...
                <p className={styles.contactAddr}>4413 S Beech Daly St<br />Dearborn Heights, MI 48125</p>
              </div>
            </div>
