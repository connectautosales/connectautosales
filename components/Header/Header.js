      ...
      <div className={styles.topBar}>
        <div className={`container ${styles.topBarInner}`}>
          ...
          <div className={styles.topBarRight}>
            {s.facebook && (
              <a href={s.facebook} target="_blank" rel="noreferrer" className={`${styles.socialIcon} ${styles.socialFb}`} aria-label="Facebook">
            ...
            {s.instagram && (
              <a href={s.instagram} target="_blank" rel="noreferrer" className={`${styles.socialIcon} ${styles.socialIg}`} aria-label="Instagram">
            ...
            {s.tiktok && (
              <a href={s.tiktok} target="_blank" rel="noreferrer" className={`${styles.socialIcon} ${styles.socialTt}`} aria-label="TikTok">
            ...
            {s.youtube && (
              <a href={s.youtube} target="_blank" rel="noreferrer" className={`${styles.socialIcon} ${styles.socialYt}`} aria-label="YouTube">
