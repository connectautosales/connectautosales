      ...
      <div className={styles.topBar}>
        <div className={`container ${styles.topBarInner}`}>
          ...
          <div className={styles.topBarRight}>
            {s.facebook && (
              <a href={s.facebook} target="_blank" rel="noreferrer" className={styles.socialIcon} aria-label="Facebook">
            ...
            {s.instagram && (
              <a href={s.instagram} target="_blank" rel="noreferrer" className={styles.socialIcon} aria-label="Instagram">
            ...
            {s.tiktok && (
              <a href={s.tiktok} target="_blank" rel="noreferrer" className={styles.socialIcon} aria-label="TikTok">
            ...
            {s.youtube && (
              <a href={s.youtube} target="_blank" rel="noreferrer" className={styles.socialIcon} aria-label="YouTube">
